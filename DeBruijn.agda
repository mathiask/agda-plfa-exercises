...
-- eval (gas 100) (plusᶜ · twoᶜ · twoᶜ · sucᶜ · `zero)
--   —↠ `suc (`suc (`suc (`suc `zero)))
...
-- eval (gas 100) (mul {∅} · two · three)
--   —↠ `suc (`suc (`suc (`suc (`suc (`suc `zero)))))
-- eval (gas 100) (mulᶜ · twoᶜ · threeᶜ · sucᶜ · `zero)
--   —↠ `suc (`suc (`suc (`suc (`suc (`suc `zero)))))
